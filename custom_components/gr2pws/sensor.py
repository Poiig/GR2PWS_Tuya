...
class GR2PWSSensorEntity(CoordinatorEntity[GR2PWSCoordinator], SensorEntity):
    ...
    def __init__(
        ...
        self.entity_id = f"sensor.gr2pws_{device_id[:8]}_{description.key}"
...
class GR2PWSIPAddressSensor(SensorEntity):
    ...
    def __init__(self, device_id: str, ip_address: str) -> None:
        ...
        self.entity_id = f"sensor.gr2pws_{device_id[:8]}_ip_address"
...
class GR2PWSEnergyPeriodSensor(CoordinatorEntity[GR2PWSCoordinator], RestoreSensor, SensorEntity):
    ...
    def __init__(
        ...
        self.entity_id = f"sensor.gr2pws_{device_id[:8]}_ele_{period}"
